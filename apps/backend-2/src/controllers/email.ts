...
export const sendErrorEmail = async (error: string, to: string) => {
  await sendEmail(to, "Error en el proceso de solicitud de crédito", {
    title: "Error en el proceso de solicitud de crédito",
    message: `Hola,

      Se ha producido un error en el proceso de solicitud de crédito. Por favor, vuelve a subir tu solicitud.
