...
/**
 * 🧾 Interface para los parámetros del template 25:
 * "GARANTÍA MOBILIARIA (MUJERES)"
 */
...
/**
 * ✍️ Genera el submission para el template 25:
 * "GARANTÍA MOBILIARIA (MUJERES)"
 */
      ...
      submitters: [
        {
          email,
          values: {
            // 📅 Fechas principales y secundarias
            dia: params.dia,
            mes: params.mes,
            año: params.año, 
