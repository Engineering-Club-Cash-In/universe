...
//    otros derivan del desglose (igual que los rubros), esos cambios exigen recalcular:
...
//      (arregla P2 "Refresh OI product columns on manual admin updates" de Codex #942: el
//      UPDATE parcial anterior actualizaba otros_ingresos pero NO las columnas oi_* que llena
//      generarSnapshotDiario desde las genéricas).
