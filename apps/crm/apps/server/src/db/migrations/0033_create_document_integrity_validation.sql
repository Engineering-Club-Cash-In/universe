...
CREATE TABLE "public"."document_integrity_validation_documents" (
	...
	"linked_file_path" text NOT NULL,
	CONSTRAINT "doc_integrity_val_document_pk" PRIMARY KEY("validation_id","opportunity_document_id")
);
--> statement-breakpoint
CREATE TABLE "public"."document_integrity_validation_approvals" (
	...
	CONSTRAINT "doc_integrity_approval_reason_not_blank" CHECK (length(btrim("reason")) BETWEEN 5 AND 1000)
);
--> statement-breakpoint
...
ALTER TABLE "public"."document_integrity_validation_documents" ADD CONSTRAINT "doc_integrity_val_document_validation_id_fk" FOREIGN KEY ("validation_id") REFERENCES "public"."document_integrity_validations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "public"."document_integrity_validation_documents" ADD CONSTRAINT "doc_integrity_val_document_opp_doc_id_fk" FOREIGN KEY ("opportunity_document_id") REFERENCES "public"."opportunity_documents"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "public"."document_integrity_validation_approvals" ADD CONSTRAINT "doc_integrity_approval_validation_id_fk" FOREIGN KEY ("validation_id") REFERENCES "public"."document_integrity_validations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "public"."document_integrity_validation_approvals" ADD CONSTRAINT "doc_integrity_approval_approved_by_fk" FOREIGN KEY ("approved_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "doc_integrity_val_document_opp_doc_idx" ON "public"."document_integrity_validation_documents" USING btree ("opportunity_document_id");--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "doc_integrity_approval_validation_unique" ON "public"."document_integrity_validation_approvals" USING btree ("validation_id");
