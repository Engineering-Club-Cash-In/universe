...
export const contratosFinanciamiento = pgTable("contratos_financiamiento", {
	...
	montoFinanciado: decimal("monto_financiado", { precision: 12, scale: 2 }).notNull(),
...
export const conveniosPago = pgTable("convenios_pago", {
	...
	montoAcordado: decimal("monto_acordado", { precision: 12, scale: 2 }).notNull(),
	numeroCuotasConvenio: integer("numero_cuotas_convenio").notNull(),
	montoCuotaConvenio: decimal("monto_cuota_convenio", { precision: 12, scale: 2 }).notNull(),
...
export const recuperacionesVehiculo = pgTable("recuperaciones_vehiculo", {
	...
	// Responsables
	responsableRecuperacion: text("responsable_recuperacion")
		.references(() => user.id),
