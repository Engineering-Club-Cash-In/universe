...
export const quotations = pgTable("quotations", {
	...
	interestRate: decimal("interest_rate", { precision: 12, scale: 8 }).notNull(), // tasa mensual

	// Costos adicionales
	insuranceCost: decimal("insurance_cost", { precision: 16, scale: 8 })
		.notNull()
		.default("0"),
	gpsCost: decimal("gps_cost", { precision: 14, scale: 2 })
		.notNull()
		.default("0"),
	transferCost: decimal("transfer_cost", { precision: 14, scale: 2 })
		.notNull()
		.default("0"),
	adminCost: decimal("admin_cost", { precision: 16, scale: 8 })
		.notNull()
		.default("0"),
	...
	royalty: decimal("royalty", { precision: 16, scale: 8 }).default("0"),
	...
	finesCost: decimal("fines_cost", { precision: 14, scale: 2 }).default("0"), // Multas
	keyCopyCost: decimal("key_copy_cost", { precision: 14, scale: 2 }).default(
		"0",
	), // Copia de llave
	...
	legalCost: decimal("legal_cost", { precision: 14, scale: 2 }).default("0"), // Gastos legales
