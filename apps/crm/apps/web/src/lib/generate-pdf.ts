...
export function generateQuotationPdf(quotation: QuotationData) {
	...
	doc.text(
		`Q${quotation.vehicleValue.toLocaleString("es-GT", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
		50,
		37,
	);
	...
	doc.text(
		`Q${quotation.downPayment.toLocaleString("es-GT", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
		60,
		60,
	);
	...
	doc.text(
		`Q${quotation.totalFinanced.toLocaleString("es-GT", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
		60,
		67,
	);
	...
	doc.text(
		`Q${quotation.monthlyPayment.toLocaleString("es-GT", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
		60,
		74,
	);
	...
	autoTable(doc, {
		startY: 105,
		head: [
			["Período", "Saldo Inicial", "Interés + IVA", "Capital", "Saldo Final"],
		],
