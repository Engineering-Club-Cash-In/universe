  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      const vehicle = await createVehicleMutation.mutateAsync({
        ...
        milesMileage: values.milesMileage ? parseInt(values.milesMileage) : null,
        kmMileage: parseInt(values.kmMileage),
      ...
      if (!values.testDrive || values.testDrive === "No") alerts.push("Sin prueba de manejo");
