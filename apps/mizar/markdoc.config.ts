...
export default defineMarkdocConfig({
	...
	tags: {
		...
		HowItWorks: {
			attributes: {
				title: { type: String, render: "title", required: true },
				steps: { type: Array, render: "steps", required: true },
			},
			render: component("./src/components/sections/HowItWorks.astro"),
		},
		ActiveProjects: {
			attributes: {
				title: { type: String, render: "title", required: true },
				projects: { type: Array, render: "projects", required: true },
				buttons: { type: Array, render: "buttons" },
			},
			render: component("./src/components/sections/ActiveProjects.astro"),
		},
		WhyTrustUs: {
			attributes: {
				title: { type: String, render: "title", required: true },
			...
			render: component("./src/components/sections/WhyTrustUs.astro"),
		},
		YieldSimulator: {
			attributes: {
				title: { type: String, render: "title", required: true },
			},
			render: component("./src/components/sections/YieldSimulator.astro"),
		},
		FAQ: {
			attributes: {
				title: { type: String, render: "title", required: true },
