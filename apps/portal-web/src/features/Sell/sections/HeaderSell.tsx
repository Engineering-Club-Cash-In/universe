...
export const HeaderSell = () => {
  ...
  return (
    <div
      className="-mt-16 relative w-full h-[860px] flex items-center justify-center overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 ">
        ...
        <p className="text-xl md:text-3xl text-gray-200">{subtitle}</p>
      </div>
    </div>
  );
};
