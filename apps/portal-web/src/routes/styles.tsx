...
function RouteComponent() {
  return (
    <div className="p-6 flex flex-col gap-4 bg-dark text-light">
      ...
      <Button size="lg" onClick={() => alert("Botón grande clicado")}>
        Toast Grande
      </Button>
      <Button size="md" onClick={() => alert("Botón mediano clicado")}>
        Botón Mediano
      </Button>
    </div>
  );
