...
| [`DECISIONES.md` · D-56](./DECISIONES.md#d-56--el-modo-agente-avisa-al-asesor-enlazado-al-aviso-inicial) | **Servicio 10 (COBROS-02)**: `POST /conversacion/modo-agente` — SimpleTech avisa que el cliente pidió un humano y el CRM le crea al asesor la alerta `bot_modo_agente`, enlazada a la de "escribió". Migración CRM `0056` corrida en dev el 2026-09-16; pendiente en prod. |
